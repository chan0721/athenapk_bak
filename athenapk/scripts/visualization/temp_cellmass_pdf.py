...
file_forename = "simulation_coolstrong/parthenon.prim."
file_lastname = ".phdf"
...
plt.yscale("log")
plt.legend()
plt.title("mixing_cooling Cell Mass PDF", fontsize=16)
plt.savefig("mixing_cool2Z_cell_mass_pdf.png")
plt.show()
